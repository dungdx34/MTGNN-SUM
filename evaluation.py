...
from HiGraph import HSumGraph, MTSumGraph
...
def main():
    ...
    parser.add_argument('--doc_max_timesteps', type=int, default=150, help='max length of documents (max timesteps of documents)')
    ...
    if hps.model == "HSG":
        ...
        dataset = ExampleSet(DATA_FILE, vocab, hps.doc_max_timesteps, hps.sent_max_len, FILTER_WORD, test_w2s_path, bert_path)
